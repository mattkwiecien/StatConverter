...
function getStanceIcon() {
  const currentStance = GetShapeshiftForm();
  if (currentStance !== 0) {
    const [stanceIcon, , ,] = GetShapeshiftFormInfo(currentStance);
    return stanceIcon;
  }
}

function getPlayerBuffRank(buff) {
  const spellId = select(10, AuraUtil.FindAuraByName(buff, 'player'));
  if (spellId) {
    const rank = GetSpellSubtext(spellId);
    return rank ? parseInt(rank.match(/(\d+)/)[1]) : 1;
  }
}
...
const _statModInfo = {
  ADD_DODGE: { initialValue: 0, finalAdjust: 0 },
  ADD_SPELL_DMG_MOD_INT: { initialValue: 0, finalAdjust: 0 },
  ADD_HEALING_MOD_INT: { initialValue: 0, finalAdjust: 0 },
  ADD_MANA_REG_MOD_INT: { initialValue: 0, finalAdjust: 0 },
  ADD_RANGED_AP_MOD_INT: { initialValue: 0, finalAdjust: 0 },
  ADD_ARMOR_MOD_INT: { initialValue: 0, finalAdjust: 0 },
  ADD_SPELL_DMG_MOD_STA: { initialValue: 0, finalAdjust: 0 },
  ADD_SPELL_DMG_MOD_SPI: { initialValue: 0, finalAdjust: 0 },
  ADD_SPELL_DMG_MOD_AP: { initialValue: 0, finalAdjust: 0 },
  ADD_HEALING_MOD_SPI: { initialValue: 0, finalAdjust: 0 },
  ADD_HEALING_MOD_STR: { initialValue: 0, finalAdjust: 0 },
  ADD_HEALING_MOD_AGI: { initialValue: 0, finalAdjust: 0 },
  ADD_HEALING_MOD_AP: { initialValue: 0, finalAdjust: 0 },
  ADD_MANA_REG_MOD_NORMAL_MANA_REG: { initialValue: 0, finalAdjust: 0 },
  MOD_ARMOR: { initialValue: 1, finalAdjust: 0 },
  MOD_HEALTH: { initialValue: 1, finalAdjust: 0 },
  MOD_MANA: { initialValue: 1, finalAdjust: 0 },
  MOD_STR: { initialValue: 0, finalAdjust: 1 },
  MOD_AGI: { initialValue: 0, finalAdjust: 1 },
  MOD_STA: { initialValue: 0, finalAdjust: 1 },
  MOD_INT: { initialValue: 0, finalAdjust: 1 },
  MOD_SPI: { initialValue: 0, finalAdjust: 1 },
  MOD_BLOCK_VALUE: { initialValue: 0, finalAdjust: 1 },
  MOD_AP: { initialValue: 0, finalAdjust: 1 },
  MOD_RANGED_AP: { initialValue: 0, finalAdjust: 1 },
  MOD_SPELL_DMG: { initialValue: 0, finalAdjust: 1 },
  MOD_HEALING: { initialValue: 0, finalAdjust: 1 }
};

const _classStatModTable = {
   "DRUID": {
      "ADD_SPELL_DMG_MOD_INT": {
         1: {"tab": 1,"num": 12,"rank": [0.08, 0.16, 0.25]}
      },
      "ADD_HEALING_MOD_INT": {
          1: { "tab": 1, "num": 12, "rank": [ 0.08, 0.16, 0.25]}
      },
